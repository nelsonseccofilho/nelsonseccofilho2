...
export default function PrivacyPageEn() {
  const common = commonContent.en;

  return (
    <>
      <SiteHeader content={common} locale="en" routeId="privacy" />
      <main className="py-[clamp(2.5rem,6vw,5rem)]">
        <section className="layout-container grid gap-5" aria-labelledby="privacy-title">
          <p className="m-0 text-sm font-semibold tracking-[0.18em] text-[var(--color-brand-text)] uppercase">Privacy</p>
