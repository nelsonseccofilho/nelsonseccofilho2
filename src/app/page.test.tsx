...
describe('HomePage', () => {
  it('renders the new header, hero and featured cases composition', () => {
    ...
    expect(screen.getAllByText(/design systems/i)).toHaveLength(2);
    ...
    expect(screen.getAllByRole('heading', { level: 3 }).map((heading) => heading.textContent)).toEqual(['HORIZON HIS', 'SUBITER', 'REDE DCC 1.0', 'DASA — Canal do Consultor', 'ConnectCar / Freeflow']);
