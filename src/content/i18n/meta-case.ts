...
const ptBR: PortfolioMetaCaseContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: ['A arquitetura bilíngue, a hierarquia editorial da Home, a ordem dos projetos, a navegação sem hierarquias artificiais, o Evidence System, os temas Light/Dark e o refinamento de escaneabilidade do SUBITER são decisões do produto — não apenas detalhes de interface.'],
    },
    {
      id: 'architecture',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '70 commits · 5 dias de atividade · ~22h de trabalho identificável até 10 de agosto.',
...
const en: PortfolioMetaCaseContent = {
  ...
  sections: [
    ...
    { id: 'product-decisions', title: 'Product and UX decisions', paragraphs: ['The bilingual architecture, editorial Home hierarchy, project ordering, navigation without artificial hierarchies, Evidence System, Light/Dark themes, and SUBITER scannability refinement are product decisions—not merely interface details.'] },
    {
      id: 'architecture',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '70 commits · 5 days of activity · ~22 hours of identifiable work through August 10.',
