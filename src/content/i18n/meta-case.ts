  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'O consumo também passou a fazer parte dessa decisão. Em uma captura de 10 de agosto de 2026, o GitHub Copilot Pro+ registrava 5.174 de 7.000 AI credits utilizados — aproximadamente 74% da capacidade incluída — com uso adicional desabilitado. A capacidade incluída estava prevista para ser renovada em 31 de agosto.',
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Usage became part of that decision as well. In an August 10, 2026 snapshot, GitHub Copilot Pro+ showed 5,174 of 7,000 AI credits used — approximately 74% of the included capacity — with additional usage disabled. The included capacity was scheduled to reset on August 31.',
